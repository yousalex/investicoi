...
import { UserType } from '@/components/landing/UseCasesTypes';
import { userCasesData, booksData } from '@/components/landing/UserCasesData';

// Import individual case components
import MarketersCase from '@/components/landing/UserCases/MarketersCase';
import DesignersCase from '@/components/landing/UserCases/DesignersCase';
import WritersCase from '@/components/landing/UserCases/WritersCase';
import ResearchersCase from '@/components/landing/UserCases/ResearchersCase';
import DevelopersCase from '@/components/landing/UserCases/DevelopersCase';
import EveryoneCase from '@/components/landing/UserCases/EveryoneCase';
